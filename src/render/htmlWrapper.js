...
export function renderHTML(body, pLink, pIdx) {
  ...
  <html lang="en">
    <head>
      ...
      <title>The Greatest Giant's Files</title>
    ...
    <body>
      <nav id="navbar" data-turbolinks-permanent><div class="brand">📁 The Greatest Giant's Files</div></nav>
      ${body}
      <div class="paginate-container">${pagination(pIdx)}</div>
      <div id="flex-container" data-turbolinks-permanent style="flex-grow: 1;"></div>
      <footer id="footer" data-turbolinks-permanent><p>Hosted with ❤️ by TheGreatestGiant</p></footer>
      <script>
